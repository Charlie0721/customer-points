...
exports.FindPointByCustomerUseCase = void 0;
const common_1 = require("@nestjs/common");
const customers_service_1 = require("../customers.service");
const response_api_commons_1 = require("../../commons/response-api.commons");
let FindPointByCustomerUseCase = class FindPointByCustomerUseCase {
    constructor(customersService) {
        this.customersService = customersService;
    }
    async main(nit) {
        try {
            const { data, error } = await this.customersService.findPointsByCustomer(nit);
            if (!data) {
...
FindPointByCustomerUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [customers_service_1.CustomersService])
], FindPointByCustomerUseCase);
exports.FindPointByCustomerUseCase = FindPointByCustomerUseCase;
//# sourceMappingURL=find-points-by-customer.use-case.js.map